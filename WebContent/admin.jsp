...
<body >
<%
    response.setHeader("Cache-Control", "no-cache, no-store, must-revalidate"); //These are understood by the browser
...
<div class="navbar">
  ...
  <div class="subnav">
   ...
   <div class="subnav">
    <button class="subnavbtn">Insert Result</i></button>
  </div>
  <form action="Logout">
      <button class="login" onclick="location.href = './login.jsp'">Logout</button>
 </form>
</div>
